...
namespace DocumentFlow.Core
{
    public class WIAScanner
    {
        ...
        public static PdfDocument Scan(bool rotate)
        {
            ...
            if (device != null)
            {
                ...
                } while (MessageBox.Show("Отсканировать еще один лист?", "Вопрос", MessageBoxButtons.YesNo, MessageBoxIcon.Question) == DialogResult.Yes);
                ...
                foreach (Image image in images)
                {
                    ...
                    SizeF pageSize = UnitConverter.Convert(sizeImage, GraphicsUnit.Inch, GraphicsUnit.Point);
