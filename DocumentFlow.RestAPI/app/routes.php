...
$app->group('/measurement', function (Group $group) {
   ...
   $group->patch('/{id}/change-state', Measurement::class . ':changeState');
...
$app->group('/okopf', function (Group $group) {
   ...
   $group->patch('/{id}/change-state', Okopf::class . ':changeState');
