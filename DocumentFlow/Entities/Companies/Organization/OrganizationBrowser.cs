...
public class OrganizationBrowser : Browser<Organization>, IOrganizationBrowser
{
        ...
        : base(repository, pageManager, settings: settings) 
    {
        ...
        GridTextColumn name = CreateText(x => x.ItemName, "Краткое наименование", width: 150, visible: false);
        GridTextColumn full_name = CreateText(x => x.FullName, "Полное наименование", width: 200, visible: false);
        ...
        GridTextColumn okopf = CreateText(x => x.OkopfName, "ОКОПФ", width: 300);
        ...
        GridCheckBoxColumn default_org = CreateBoolean(x => x.DefaultOrg, "Основная", width: 100);
