...
{
    partial class WaybillReceiptEditor
    {
        /// <summary> 
        ...
        private void InitializeComponent()
        {
            ...
            label1 = new Label();
            selectPurchase = new Controls.Editors.DfDocumentSelectBox();
            ...
            selectContract.HeaderWidth = 120;
            ...
            // selectPurchase
            // 
            selectPurchase.DisableCurrentItem = false;
            selectPurchase.Dock = DockStyle.Top;
            selectPurchase.EditorFitToSize = false;
            selectPurchase.EditorWidth = 400;
            selectPurchase.EnabledEditor = true;
            selectPurchase.Font = new Font("Segoe UI", 9.75F, FontStyle.Regular, GraphicsUnit.Point);
            selectPurchase.Header = "Заявка на покупку";
            selectPurchase.HeaderAutoSize = false;
            selectPurchase.HeaderDock = DockStyle.Left;
            selectPurchase.HeaderTextAlign = ContentAlignment.TopLeft;
            selectPurchase.HeaderVisible = true;
            selectPurchase.HeaderWidth = 120;
            selectPurchase.Location = new Point(0, 108);
            selectPurchase.Margin = new Padding(3, 4, 3, 4);
            selectPurchase.Name = "selectPurchase";
            selectPurchase.Padding = new Padding(0, 0, 0, 7);
            selectPurchase.ShowDeleteButton = true;
            selectPurchase.ShowOpenButton = true;
            selectPurchase.Size = new Size(951, 32);
            selectPurchase.TabIndex = 10;
            selectPurchase.DocumentDialogColumns += SelectPurchase_DocumentDialogColumns;
            selectPurchase.DataSourceOnLoad += SelectPurchase_DataSourceOnLoad;
            selectPurchase.OpenButtonClick += SelectPurchase_OpenButtonClick;
            selectPurchase.SelectedItemChanged += SelectPurchase_SelectedItemChanged;
            selectPurchase.UserDocumentModified += SelectPurchase_DocumentSelectedChanged;
            // 
            // WaybillReceiptEditor
            // 
            AutoScaleDimensions = new SizeF(7F, 15F);
            AutoScaleMode = AutoScaleMode.Font;
            Controls.Add(gridContent);
            Controls.Add(selectPurchase);
            Controls.Add(panelDoc1C);
            Controls.Add(selectContract);
            Controls.Add(selectContractor);
            Controls.Add(lineSplitter1);
            Controls.Add(panel1);
            Name = "WaybillReceiptEditor";
        ...
        private Controls.Editors.DfDocumentSelectBox selectPurchase;
    }
}
