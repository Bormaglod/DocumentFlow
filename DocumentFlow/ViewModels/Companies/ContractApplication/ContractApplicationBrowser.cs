...
{
    public ContractApplicationBrowser(IServiceProvider services, IPageManager pageManager, IContractApplicationRepository repository, IConfiguration configuration) 
