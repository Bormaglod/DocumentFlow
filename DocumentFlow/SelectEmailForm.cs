...
namespace DocumentFlow
{
    ...
    public partial class SelectEmailForm : MetroForm
    {
        ...
        private async Task SendEmailAsync(Email email, EmailAddress emailFrom, IEnumerable<EmailAddress> emailTo)
        {
            ...
            await conn.ExecuteAsync("insert into email_log (email_id, date_time_sending, to_address, document_id) values (:email_id, :date_time_sending, :to_address, :document_id)", log, transaction);
            transaction.Commit();
        }
